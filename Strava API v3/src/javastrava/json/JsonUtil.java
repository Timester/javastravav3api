...
public interface JsonUtil {
	 ...
	 */
    <T> T deserialise(final InputStream is, final Class<T> class1);
	 ...
	 */
    <T> T deserialise(final String input, final Class<T> class1) throws JsonSerialisationException;
	 ...
	 */
    <T> String serialise(final T object);
